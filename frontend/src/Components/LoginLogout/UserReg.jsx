          ...
          >
            <VStack width={'25%'}>
              ...
              <Text
                ...
                textAlign={'center'}
              >
                You are just 30min away from getting your Skill based job near
                you !!
              </Text>
            </VStack>
            <VStack width={'70%'}>
              ...
              <Stack spacing={4}>
                ...
                <Input
                  ...
                  size="md"
                />
                <Select placeholder="Select your Interests" variant={'filled'}>
                ...
                <Input
                  ...
                  size="md"
                />
                <Button size={'lg'} colorScheme='orange' variant={'solid'}>Submit</Button>
              </Stack>
            </VStack>
          </HStack>
      </Box>
