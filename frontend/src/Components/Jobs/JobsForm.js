import { Box, Button, HStack, Heading, Input, InputGroup, InputLeftAddon, Select, Stack, Text, Textarea, VStack,} from '@chakra-ui/react';
...
const JobsForm = () => {
    ...
    function submitJob() {
      ...
      const temp = {...job, companyId: "123xyz", skills:["Communication", "SAP"], interests: ["Business"]};
            ...
            <VStack width={'70%'} >
              ...
              <Stack spacing={4} overflowX={'scroll'}>
                ...
                <HStack>
                  ...
                  <Input
                    value={job.openings}
                    onChange={e => setJob({...job, openings: e.target.value})}
                    variant={'filled'}
                    _placeholder={{ color: 'black' }}
                ...
                <Input
                    value={job.salRange}
                    onChange={e => setJob({...job, salRange: e.target.value})}
                    variant={'filled'}
                    _placeholder={{ color: 'black' }}
                ...
                <Textarea
                  value={job.jobDesc}
                  onChange={e => setJob({...job, jobDesc: e.target.value})}
                  variant={'filled'} 
                ...
                <Button type="submit" onClick={submitJob} size={'lg'} colorScheme="orange" variant={'solid'}>
                  Submit
                </Button>
              </Stack>
            </VStack>
