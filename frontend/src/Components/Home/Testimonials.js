...
const Testimonials = () => {
    return (
        <>
            <Box width={'100%'} height={'100vh'} className='testi' display={'flex'} justifyContent={'center'} alignItems={'center'}>
                <VStack width={'80%'} margin={'auto'} >
                    <Heading>
                        Our Testimonials
                    </Heading>
                    <Text >Customer Review is Very Important</Text>
                    <Box width={'40%'} margin={'auto'} height={'10px'} borderRadius={"60%"} backgroundColor={'orange'}></Box>
                    <Stack marginY={'50px'} direction={'row'}>
                        <Box margin={'auto'} className='boxdesign' paddingX={'30px'} paddingY={'20px'} borderRadius={'10px'} boxShadow={'0px 10px 61px 26px rgba(0,0,0,0.1)'}>
